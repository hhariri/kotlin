 ...
 */
public fun String.replace(firstIndex: Int, lastIndex: Int, replacement: String): String {
 ...
 * Replace part of string at given range with replacement string
 */
public fun String.replace(range: IntRange, replacement: String): String {
    val sb = StringBuilder()
...
public fun String.replaceBefore(delimiter: Char, replacement: String): String {
    val index = indexOf(delimiter)
    return if (index == -1) this else replace(0, index, replacement)
}
...
public fun String.replaceAfter(delimiter: Char, replacement: String): String {
    val index = indexOf(delimiter)
    return if (index == -1) "" else replace(index + 1, length, replacement)
}
...
public fun String.replaceAfter(delimiter: String, replacement: String): String {
    val index = indexOf(delimiter)
    return if (index == -1) "" else replace(index + +delimiter.length, length, replacement)
}
